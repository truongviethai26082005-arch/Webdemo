  ...
  return (
    <div className="rounded-2xl border border-slate-200/90 bg-white p-4 sm:p-5 shadow-xs space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-3 border-b border-slate-200">
            ...
            <Badge
              ...
              className={
                safeData.isSalarySafe
                  ? "bg-emerald-50 text-emerald-700 border-emerald-200 text-[10px] font-semibold py-0.2 px-2"
                  : "bg-rose-50 text-rose-700 border-rose-200 text-[10px] font-semibold py-0.2 px-2"
              }
            >
        ...
        <div className="text-xs text-slate-500 flex items-center gap-1.5 self-start sm:self-auto font-medium">
          <Calculator className="w-3.5 h-3.5 text-slate-400" />
          <span>Thời gian thực</span>
        </div>
      </div>

      {/* Main Calculation Grid - Chuẩn Design Tokens */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="bg-white border border-slate-200/90 hover:border-slate-300 rounded-2xl p-4 shadow-xs flex flex-col justify-between h-full transition-all">
          <div className="flex items-center justify-between gap-2">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-500">Doanh thu thực thu (A)</span>
        ...
        <div className="bg-white border border-slate-200/90 hover:border-slate-300 rounded-2xl p-4 shadow-xs flex flex-col justify-between h-full transition-all">
          <div className="flex items-center justify-between gap-2">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-500">Lương giáo viên (B)</span>
          ...
          <div>
            ...
            <div className="text-xs text-slate-400 truncate">
              Tỷ trọng: {safeData.salaryCostRatioPercent}% (An toàn: ≤45%)
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/90 hover:border-slate-300 rounded-2xl p-4 shadow-xs flex flex-col justify-between h-full transition-all">
          <div className="flex items-center justify-between gap-2">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-500">Lợi nhuận gộp (A - B)</span>
          ...
          <div>
            ...
            <div className="text-xs text-slate-400 truncate">
              Biên: {safeData.grossMarginPercent}% (Chưa trừ phí cố định)
            </div>
          </div>
        </div>
      </div>
